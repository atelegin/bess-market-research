...
:class:`lib.models.dispatch.adp.shadow_cost.ADPPolicy`.
...
:class:`lib.models.dispatch.adp.shadow_cost.ADPPolicy` wrapper.
...
current scope, use :class:`lib.models.dispatch.adp.shadow_cost.AgingAwareDepreciationPolicy`
